            ...
            <nav className="mx-auto max-w-screen-xl px-4 sm:px-10 py-4 flex flex-col relative">
                <div className="flex items-center justify-between">
                    ...
                    <div className="hidden sm:flex gap-4 text-gray-300 pr-10 flex-row">
                        <Link href="/pages/projects" className="hover:text-white px-2 text-sm sm:text-base w-[50%] font-bold">Projects</Link>
                        <Link href="/pages/todo" className="hover:text-white px-2 text-sm sm:text-base w-[50%] font-bold">To-do</Link>
                        <Link href="/pages/about" className="hover:text-white px-2 text-sm sm:text-base w-[15%] font-bold">About</Link>
                    </div>
